...
public class company1 {
    ...
    public static void main(String[] args) {
        ...
        // set/get của đối tượng dev, gán giá trị nhập từ scanner với thuộc tính private
        // (overtime)
        ...
        // phía dưới các đối tượng còn lại mình cho giá trị tượng trưng in ra luôn cho
        // đẹp cô ạ, không thì dài quá cô ạ.
        dev dev1 = new dev();
        dev1.id = "1235";
        dev1.name = "Huyền";
